...
export default function MarketSkillCard({
  ...
  return (
    <div className="bg-neutral-900/80 border border-neutral-800 hover:border-neutral-700/80 rounded-2xl p-4 sm:p-5 transition-all shadow-md hover:shadow-lg flex flex-col justify-between space-y-4">
      ...
      <div className="space-y-2">
        <div className="flex items-start justify-between gap-3">
          <div className="space-y-1 min-w-0">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {skill.category && (
                <span className="text-[10px] font-mono px-2 py-0.5 rounded-md bg-neutral-800 text-neutral-400 border border-neutral-700/60 shrink-0">
                  {skill.category}
                </span>
              )}
            </div>
          ...
          <div className="shrink-0">
            ...
            {trend === "STABLE" && (
              <span className="inline-flex items-center gap-1 text-[11px] font-semibold px-2.5 py-1 rounded-full bg-blue-500/10 text-blue-400 border border-blue-500/20">
        ...
        <div className="text-[10px] text-neutral-500 bg-neutral-950/60 px-2.5 py-1 rounded-lg border border-neutral-800/80">
          <span className="text-neutral-400 font-medium">Market Fact:</span> Employer hiring demand in India (not your personal skill status)
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 pt-1">
        ...
        <div className="p-3 rounded-xl bg-neutral-950/70 border border-neutral-800 space-y-1.5">
          ...
          <div className="text-[10px] font-mono text-indigo-300 text-right">
        ...
        <div className="p-3 rounded-xl bg-neutral-950/70 border border-neutral-800 space-y-1.5">
          ...
          <div className="text-[10px] text-neutral-500 flex items-center justify-between">
            ...
            <span className="font-mono text-neutral-300">{trend}</span>
          </div>
      ...
      <div className="pt-2 border-t border-neutral-800/80 flex items-center justify-between gap-2 text-xs">
        {onExploreInRoadmap && (
          <button
            ...
            className="inline-flex items-center gap-1.5 text-emerald-400 hover:text-emerald-300 font-medium transition-colors cursor-pointer text-xs"
          >
        ...
        {onAskAssistant && (
          <button
            ...
            className="inline-flex items-center gap-1.5 text-purple-400 hover:text-purple-300 font-medium transition-colors cursor-pointer text-xs ml-auto"
          >
