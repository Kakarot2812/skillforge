...
class UserPracticeProgress(Base):
    ...
    __table_args__ = (
        UniqueConstraint("user_id", "roadmap_skill_id", "problem_id", name="uq_user_practice_progress_user_skill_problem"),
        CheckConstraint("status IN ('NOT_STARTED', 'IN_PROGRESS', 'COMPLETED')", name="ck_user_practice_progress_status"),
    )
